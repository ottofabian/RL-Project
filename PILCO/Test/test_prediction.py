...
def test_smgpr():
    ...
    mgpr = SparseMultivariateGP(length_scales=length_scales, n_targets=n_targets, X=X0, y=Y0, n_inducing_points=30,
                                container=GaussianProcess, sigma_eps=sigma_eps, sigma_f=sigma_f)
    mgpr.fit(X0, Y0)
