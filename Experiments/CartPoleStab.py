...
# a3c = A3C(n_worker=3, env_name='Pendulum-v0', lr=0.0001, is_discrete=False, seed=seed, optimizer_name='rmsprop')
# a3c.run()
...
# pilco = PILCO(env_name='CartpoleSwingShort-v0', seed=seed, n_features=100, Horizon=20,
#               cost_function=cartpolebase_costfunc)
pilco.run(200)
